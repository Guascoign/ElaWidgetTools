/********************************************************************************
    * 文件名称 ：Prt_FSM7050_2.h
    * 作     者：ZM
    * 版     本：V1.0
    * 编写日期 ：2025-06-06
    * 功     能：通信协议 界面
*********************************************************************************/
#ifndef _PRT_FSM7050_2_H
#define _PRT_FSM7050_2_H
...
class Prt_FSM7050_2 : public ProtocolBaseWidget
{
    Q_OBJECT
public:
    explicit Prt_FSM7050_2(QWidget *parent = nullptr);
    ~Prt_FSM7050_2();
public slots: 
    void SerialConnected(bool connected) override;
    void SerialDataReceived(QByteArray data) override;
    void Creat_data(uint8_t *data, uint8_t mode, int16_t X1, int16_t Y1 , int16_t X2, int16_t Y2);//生成协议
...
private:
    ...
    ElaText* X2_Info = nullptr;
    ElaText* Y2_Info = nullptr;
    ElaText* X1_Zero = nullptr;
    ElaText* Y1_Zero = nullptr;
    ElaText* X2_Zero = nullptr;
    ElaText* Y2_Zero = nullptr;
    ElaComboBox* Mode_Select = nullptr;
    ElaLineEdit* X1_Edit = nullptr;
    ElaLineEdit* Y1_Edit = nullptr;
    ElaLineEdit* X2_Edit = nullptr;
    ElaLineEdit* Y2_Edit = nullptr;
