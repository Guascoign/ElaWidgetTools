...
//控件
#include "ElaText.h"
STM32_OTA_T::STM32_OTA_T(QWidget* parent)
    : T_BasePage(parent)
{
ElaWindow* window = dynamic_cast<ElaWindow*>(parent);

    // 预览窗口标题
    setWindowTitle("StM32 OTA");
    // 顶部元素
    createCustomWidget("程序升级");

    // 顶部元素
   // createCustomWidget("串口连接");

    QWidget* centralWidget = new QWidget(this);
    centralWidget->setWindowTitle("StM32 OTA");
